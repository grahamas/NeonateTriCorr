...
detect_all_patients_seizures(patients_considered; save_dir=save_dir, task_name="$(signal_type)$(reduction_type)", params..., signals_reduction_name=reduction_type, signal_from_dct_fn = (dct -> dct["contributions"]))
end
