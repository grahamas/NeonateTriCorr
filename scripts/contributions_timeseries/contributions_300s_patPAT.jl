...
# Define START_S before running this script
...
let eeg = load_helsinki_eeg(PAT), eeg = snip(eeg, START_S, START_S+30);
...
plots_subdir = plotsdir("timeseries_300s_AN_pat$(PAT)_start_$(START_S)_$(Dates.format(Dates.now(), "yyyy_mm_dd-HHMMSS"))")
mkpath(plots_subdir)
