...
label_A = fig[1,1,TopLeft()] = Label(fig, "A", font=noto_sans_bold, fontsize=56, halign=:left)
label_B = fig[1,2,TopLeft()] = Label(fig, "B", font=noto_sans_bold, fontsize=56, halign=:left)
label_C = fig[2,1,TopLeft()] = Label(fig, "C", font=noto_sans_bold, fontsize=56, halign=:left)
label_D = fig[2,2,TopLeft()] = Label(fig, "D", font=noto_sans_bold, fontsize=56, halign=:left)
